import { BigNumber, Contract, providers, utils, Signer } from "ethers";
...
export default function Home() {
  ...
  const mintCryptoDevToken = async (amount: BigNumber) => {
    try {
      ...
      const value = amount.toNumber() / 1000;
      console.log(value);
      ...
      return (
        <div>
          <div className={styles.description}>
            <p>{tokensToBeClaimed.mul(10) + "Tokens can be claimed!"}</p>
          </div>
      ...
      <div style={{ display: "flex-col" }}>
        <div>
          <input
            ...
            onChange={(e) =>
              setTokenAmount(BigNumber.from(Number(e.target.value) || "0"))
            }
    ...
    <div>
      ...
      <div className={styles.main}>
        ...
        <div className={styles.image}>
          <Img src="./0.svg" alt="Image" fill={true} />
        </div>
      </div>
    </div>
  );
